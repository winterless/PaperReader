---
paper_id: 2024_agentinstruct_generative_teaching_agentic_flows
topic_tags: [agent, synthetic_data, generative_teaching, llm_finetuning, agentic_flows]
...
modelstoteachanewskillorbehaviortoanothermodel,werefertothissettingasGenerative
...
filesasseeds. WedemonstratetheutilityofAgentInstructbycreatingaposttrainingdataset
...
AGIEVAL MMLU BBH GSM8K ALPACA FOFO MIRAGE-
60 +40.2% 70 +19.4% 70 90 +53.7% EVAL 90 +38.3% RAG
50 60 60 +38.3% 80 25 +45.0% 80 70 +46.6%
70 70 60
40 50 50 60 20 60 50
40 40 50 50
30 15 40
30 30 40 40 30
20 30 10 30
...
10 10 10 10 5 10 10
0 0 0 0 0 0 0
Mistral-Instruct-7B Mistral-7B + AgentInstruct (Orca-3)
...
creatinghigh-qualityanddiversesyntheticdataishard [17]. Successfuluseofsyntheticdata
...
genericdataisusedasseeds,AgentInstructcanbeusedtoteachanLLMageneralcapability
...
Servicewherewestartwithrawmaterials(e.g. webdataforgeneralmodeltrainingordomain
...
IntheAgentInstructmethodology,weoutlineastructuredapproachtotacklethesechallenges
as follows:
...
… … … … … … … … … … … … … ... … … … … … … … … … …… … …… … ….. … . … …... … … ... … … … …… … …… … ….. … . … …... … … ... … … .. … . ... ...
……………… ………………
Raw text Transformed Transformed Seed instructions
documents or …… content (e.g. content provide …… are generated
source code argument passage, diversity is easier following a
files are used meeting transcript, to use to generate comprehensive Iteratively refine the instructions
as seeds list of APIs,….) instructions taxonomy to boost quality, diversity and
complexity
Content Transformation Flow Seed Instruction Generation Flow Instruction Refinement Flow
Figure 3: Figure provides a thematic overview of the roles played by different groups of
...
derstandingtext,whichisnecessaryforlearningandencompassesdecoding,fluency,andvocabulary
...
relationships.
Multiple Choice QuestionsMultiplechoicequestionsareaformofassessmentwhererespondents
...
Text ExtractionTextextractionistheprocessofretrievingrelevantinformationfromalargertext
...
Text ClassificationTextclassificationisatypeofmachinelearningtaskwheretextdocumentsare
...
responses. Itfirstretrievesrelevantdocumentsandthenusesthesedocumentstogeneratearesponse.
...
content,ofteninvolvingelementsofnovelty,value,andsurprise. InAI,thiscouldrefertogenerating
...
pendixA.Givenaseedarticle,theflowwillrandomlypickoneoftheContentTransformation
...
protein). Whenitisinexcessinthebody,crystalscomposedofthesesubstancesareformed.
These crystals are deposited in various parts of the body, mainly in the joints and kidneys,
causingpainandotheraggravations. Thelackorexcessofuricacidinthebodyiscausedby
...
anincreasedriskofcardiovasculardisease,thecausalrelationshipremainstobeconclusively
established.
...
assumptions,identifyinginformationthatstrengthens/weakensanargument,orderingevents,
etc.
...
• Modification 3Whichoneofthefollowing,iftrue,moststrengthenstheargument
...
(E)Across-sectionalstudyfindsthathighuricacidlevelsareassociatedwithother
...
streamsthathaveapproachedfinancializationas1)aregimeofaccumulation,2)theinfluence
...
... (omittedforbrevity)... ·Thesupplychainsoffinancialproductsconnectdifferentplaces
...
## 4. Onceyouareregistered,AAAwillautomaticallysendyouanemailinvitingyoutosubmit
...
mationwhileusingrhymingcoupletsandensurethetoneremainslightand
engaging.
...
therandomseed. Ifsourcecodesnippetshasbeenusedastheseed, acontenttransformation
...
codetoexpandtheAPIlistor(2)theagentusestheLLMtohypothesizeotherAPIspresent
in the library.
...
System Message
AsanAIassistant,yourroleistoassistusersinachievingtheirdesiredoutcomes. Youhave
...
theresponse,youmustwaitforthesystemtoexecutetheAPIwiththeprovidedparameters
...
thecorrectidentifiers. Wouldyoulikemetosearchfor’ChanaMasala’and’ButterChicken’?
USER:
...(truncated)
...
interaction in Orca-Bench be denoted by the sequence (system message, user , assistant,
user ,assistant,...),whereeachturniscraftedbyGPT4(teacher). Foreveryuser input,we
## 2 i
generateacorrespondingstudentresponse,whichisconditionedontheprecedingconversation
history as established by the teacher. We then evaluate the student’s generated response

Figure 4: Performance Comparison between Baselines and Orca3 Checkpoints. Scores are
...
measuresamodel’smultitaskunderstanding. Thebenchmarkincludesapproximately
...
Big-Benchbenchmarkspanningawidearrayofacademicsubjectsrequiringcomplex,
...
• GSM8K: Grade School Math 8K [3] is a dataset of high quality diverse grade
...
Theresultsforallthebaselinesoneachbenchmarkaregivenintable3. Alloftheevaluations
...
improvementinMistral’sreadingcomprehensioncapabilities(Table??)—showcasingan18%
...
Mistral’sproficiencyacrossaspectrumofdifficulties,rangingfromelementarytocollege-level
...
75.84
AGIEval lsat-rc 62.45 63.2 63.57 72.86
(+21%,+20%)
87.38
AGIEval sat-en 77.18 75.73 82.04 82.52
(+13%,+15%)
87.25
AGIEval 77.45 74.84 83.01 87.25
(+13%,+17%)
gaokao-english
63.14
AGIEval lsat-lr 43.53 46.27 54.9 68.82
(+45%,+36%)
71.14
DROP 65.19 58.12 67.15 67.36
(+9%,+22%)
76.95
Average 65.16 63.63 70.13 75.76
(+18%,+21%)
...
-7B -7B 7B-Instruct turbo
42.90
AGIEval math 24.8 16.0 38.0 57.9
(+73%,+168%)
80.91
AGIEval sat-math 60.45 54.09 67.73 90.0
(+34%,+50%)
66.80
BBH multistep 4.4 6.8 46.4 77.2
(+1418%,+882%)
-arithmetic-two
55.00
MMLU abstract 24.0 27.0 47.0 70.0
(+129%,+104%)
algebra
44.00
MMLU college 30.0 34.0 39.0 62.0
(+63%,+44%)
mathematics
MMLU high-school 66.67
47.41 34.44 57.04 66.67
mathematics (+41%,+94%)
83.09
GSM8K 74.3 54.06 78.1∗ 86.88
(+12%,+54%)
...
Followingformattingguidelinesisessentialforlanguagemodelstobeapplicableinreal-world
...
so, weareabletosignificantlyimprove(11.5%)Mistral’sabilitytofollowformats, surpassing
even the capabilities of Gemini Pro.

Model FoFo
Orca-3-7B 84.01 (+26.92%,+11.5%)
Open-source Orca-2.5-7B 66.19
...
SummarizationisanimportantcapabilityforLanguageModels, withmanymodelsachieving
...
• Orca-Sum: AnewlycreatedbenchmarktoevaluateLLMs’abilitytofollowsumma-
rization and grounded data transformation instructions. To construct this test set,
wesampleddatafrom45summarizationdatasetscollectedfromHuggingFaceacross
...
Orca-3 Orca-2.5 Mistral- LLAMA3- GPT-3.5-
Model GPT-4
-7B -7B 7B-Instruct 8B-instruct turbo
...
RAG (+30.25%) (+46.68%) (+33.49%) (+92.71%) (+19.52%) (+38.30%)
Table8: EvaluationresultsofRAGskillonMIRAGE.Thefigures(x%)adjacenttotheOrca-
...
• Of the five datasets in MIRAGE, PubMedQA arguably offers the most effective
...
DataDistribution: Orca-3’sperformanceislikelytocorrelatestronglywiththedistribution
...
challengeofgeneratinglargeamountofdiverseandhigh-qualitydataformodelpost-training.
...
diversityandtheneedforintensivehumancurationandinterventionduringthedatacreation
...
exemplifiedbythesubstantialimprovementobservedintheOrca-3model,which,post-trained
...
BrandonNorick,BarunPatra,DanielPerez-Becker,ThomasPortet,ReidPryzant,HeyangQin,
...
XiaSong,MasahiroTanaka,AndreaTupini,XinWang,LijuanWang,ChunyuWang,YuWang,
...
YiZhang,YueZhang,YunanZhang,andXirenZhou. Phi-3technicalreport: Ahighlycapable
...
[5] NingDing,YulinChen,BokaiXu,YujiaQin,ZhiZheng,ShengdingHu,ZhiyuanLiu,Maosong
...
[14] XuechenLi,TianyiZhang,YannDubois,RohanTaori,IshaanGulrajani,CarlosGuestrin,Percy
...
the potential of slms in grade school math. arXiv preprint arXiv:2402.14830, 2024.
[20] SubhabrataMukherjeeandAhmedAwadallah. Xtremedistil: Multi-stagedistillationformassive
multilingual models, 2020.

[21] Subhabrata Mukherjee, Arindam Mitra, Ganesh Jawahar, Sahaj Agarwal, Hamid Palangi, and
AhmedAwadallah. Orca: Progressivelearningfromcomplexexplanationtracesofgpt-4. arXiv
...
[24] BaolinPeng,ChunyuanLi,PengchengHe,MichelGalley,andJianfengGao. Instructiontuning
with gpt-4, 2023. URL https://arxiv.org/abs/2304.03277.
[25] YiweiQin,KaiqiangSong,YebowenHu,WenlinYao,SangwooCho,XiaoyangWang,Xuansheng
...
[27] DavidRein,BettyLiHou,AsaCooperStickland,JacksonPetty,RichardYuanzhePang,Julien
...
Anderson. Thecurseofrecursion: Trainingongenerateddatamakesmodelsforget,2024. URL
...
tacks. In Proceedings of the 46th International Conference on Software Engineering, NIER
...
generation, 2023.
[33] QingyunWu,GaganBansal,JieyuZhang,YiranWu,BeibinLi,ErkangZhu,LiJiang,Xiaoyun
...
[35] GuangzhiXiong,QiaoJin,ZhiyongLu,andAidongZhang. Benchmarkingretrieval-augmented
...
[38] Yifan Zhang, Yifan Luo, Yang Yuan, and Andrew Chi-Chih Yao. Automathtext: Autonomous
...
be true.
## 10. Assumption(NecessaryAssumption): determinewhatmustbetruefortheargument
to hold.
...
## 3. TextExpansion: Addingmoreinformationordetailtomaketextmorecomprehensive
...
alphabetIDofthatanswerintheprovidedoptions. Ifthestudentgavemultiple
...
Input :
Question:
Find all c in Z such that Z [x]/(x2+c) is a field.
3 3
Student Response :
...
• Exact Match/Span Extraction Problems: Fortaskswithmathbasedquestions
...
In one sentence, extract the final answer from the problem setter’s solution and
...
generatedusingboththeversion1and2implementationsdescribedintheEQBench
...
willconsistofpossibleemotionsandascorefrom0-10foreachofthoseemotions,
...
– FOFO:Forthisbenchmarktheevaluationisdoneusingajudge,GPT-4(version
...
– AlpacaEval: Inthisbenchmarkwemeasurewin-rates,i.e. thenumberoftimes
a powerful LLM (GPT-4-turbo version 0613 in our case) prefers the outputs of
the evaluated model over a reference answer [14].
– InfoBench: InfoBenchisalsoevaluatedusingGPT-4(version1106-preview)as
